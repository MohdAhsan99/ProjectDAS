...
public class PatientService {
	...
	public Patients register(DummyPatients p) {
		...
		Patients pt = new Patients(p.getFname_(), p.getLname_(), p.getGender_(), p.getEmail_(), p.getPassword_(),
				p.getAddress_(), p.getDob_(), p.getContact_(), u);
	...
	{
		Doctors doc=drepo.getDoctorByDId(app.getDoctor_id_());
